...
class Task:
    ...
    def __init__(self, crit, bgt_lo, bgt_hi, prio_lo, prio_hi,
        ...
        self.slack = 0.0   # Task slack available.
        self.dp_lo = 0.0  # Task deferred preemption time slot length.
        self.dp_hi = 0.0   # Task deferred preemption time slot length.
        self.pt = self.prio_lo   # Task preemption threshold
